<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManageStudentEvents_admin.aspx.cs" Inherits="ManageStudentEvents_admin" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta charset="utf-8" />
    <title>Manage Student Events</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="table-title">Student Events</div>
            <div class="grid-box">
                <asp:GridView ID="gvEvents" runat="server" CssClass="events-grid"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Circular" ItemStyle-Width="120px">
                            <ItemTemplate>
